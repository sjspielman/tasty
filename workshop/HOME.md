...
* Please install the [required software](../additional-resources/software-setup.md) and take a look at how we intend to use these platforms during the workshop (see below).
...
During instruction sessions, Data Lab staff will lead you through course material using [Zoom](../software-setup/zoom-procedures.md), [Slack](../software-setup/slack-procedures.md), and [RStudio Server](../software-setup/rstudio-login.md).
